...
import {Box, Checkbox, Popover, Popper, Stack, Table, TableBody, TableCell, TableRow, TextField,} from '@mui/material';

import {useDispatch, useSelector} from 'react-redux';
import {CHANGE_PAGE_NUM, CHANGE_PAGE_SIZE, UPDATE_CURRENT_NAMESPACE,} from '../../../actions/instanceAction';
...
import {getRouteRules, UPDATE_CURRENT_SERVICE} from '../../../actions/routectlActions';
...
export default function RouteRuleOverviewTable(props) {
    ...
    useEffect(() => {
        ...
        if (
            ...
            const currentServiceName = metadata.length === 2 ? metadata[1] : metadata[0];
            dispatch(
                getRouteRules({
