...
import {addRouteRule} from '../../../../actions/routectlAction'
...
export default function RouteControlConfig(props) {
  ...
  return (
    <Box sx={style}>
      <KubeDeploymentCard
        title={intl.messages["routectl.jsonConfig"]}
