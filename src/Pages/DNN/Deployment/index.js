...
import { InferProgress } from './CreateProgess';
...
export default function ModelDeploymentPage() {
  ...
  const headRow = [
    createRow(
      'name',
      intl.messages['inferPlan.planName'],
      true,
      '100px',
      '100px',
      true,
    ...
    createRow(
      'modelList',
      intl.messages['inferPlan.modelNum'],
      false,
      '120px',
      '130px',
      colDisplay[1],
    ...
    createRow(
      'serverList',
      intl.messages['inferPlan.serverNum'],
      false,
      '120px',
      '130px',
      colDisplay[2],
    ...
    createRow(
      'comment',
      intl.messages['inferPlan.comment'],
      false,
      '120px',
      '130px',
      colDisplay[3],
      ...
      <Box>
        ...
        >
          <Stack direction='row' spacing={2}>
            ...
            >
              {intl.messages['inferPlan.createPlan']}
            </KubeConfirmButton>
          </Stack>
        </Box>
