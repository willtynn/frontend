...
export const UPDATE_SAME_USER_ON_NEXT_ITERATION = "UPDATE_SAME_USER_ON_NEXT_ITERATION";
...
export const UPDATE_HTTP_REQUEST_CONTENT_ENCODING = "UPDATE_HTTP_REQUEST_CONTENT_ENCODING";
