export const messages = {
  ...
  evolution: {
    ...
    setEvolutionPlanName: '请输入演化计划的名称',
    createEvolutionPlan: '创建演化计划',
    modifyEvolutionPlan:'修改演化计划',
    ...
    analyseConfigurationDescription: '请选择分析配置算法',
    planConfiguration: '规划配置',
    planConfigurationDescription: '请选择规划配置算法',
    executeConfiguration: '执行配置',
    executeConfigurationDescription: '请选择执行配置',
    evolutionPlanRemarks: '演化计划备注',
    setEvolutionPlanRemarks: '请输入演化计划备注',
    executeEvolution: '执行演化',
    executeEvolutionOrUnable: '执行/停止演化',
    evolutionGoal: '演化目标',
    triggerCondition: '触发条件',
    evolutionMean: '演化手段',
    evolutionAlgorithm: '演化算法',
    analyseAlgorithm: '分析算法',
    executeAlgorithm: '规划算法',
    executeMethod:'执行配置',
    ...
    analysisAlgorithmDes: '分析算法描述',
    planningAlgorithm: '规划算法',
    planningAlgorithmDes: '规划算法描述',
    analysisAlgorithmManagement: '分析算法管理',
    planningAlgorithmManagement: '规划算法管理',
    ID: 'ID',
    name: '算法名称',
    ...
    back: '返回',
    algorithmName: '算法名称',
    algorithmNameDes: '此处为算法的名称',
    algorithmDescription: '算法描述',
    algorithmDescriptionDes: '简要描述算法',
    type: '类型',
    java: '算法内容,请使用JAVA语言并阅读',
    referenceManual: '参考手册',
    revision: '修改该算法',
    delete: '删除',
    deletePrompt: '该操作不可逆，是否确定删除？',
    createPlanningAlgorithm: '新增规划算法',
    createAnalysisAlgorithm: '新增分析算法',
    system: '系统',
    user: '用户',
    registerAlgorithmType: '注册算法类型为',
    registerAlgorithm: '注册',
    evolutionAlgorithmManagement: '管理演化算法',
    info: '算法信息',
    input: '输入来源',
    output: '算法输出',
    parameter: '参数',
    ...
    addAlgorithm:'新增算法',
    addInput: '添加输入来源',
    queryAllAlgorithmError: '获取算法失败',
    addAlgorithmSuccess: '新增算法成功',
    addAlgorithmError: '新增算法失败',
    deleteAlgorithmSuccess: '删除算法成功',
    deleteAlgorithmError: '删除算法失败',
    queryAlgorithmError: '查询算法失败',
    updateAlgorithmSuccess: '更新算法成功',
    updateAlgorithmError: '更新算法失败',
    algorithmSearchPrompt: '请输入算法名称',
    numsPerPage:'每页显示',
    noData: '无数据',
    query: '查询',
    createTime: '创建时间',
    updateTime: '更新时间',
    algorithmInfo: '算法详细信息',
    editAlgorithm: '编辑算法',
    isDelete: '是否删除',
    id: 'Id',
    submitEdit: '提交更改',
    createInstance: '创建实例',
    instanceInfo: '实例详情',
    queryAllInstanceError: '获取全部实例失败',
    queryInstanceError: '获取算法实例失败',
    runName: '实例名称',
    instanceBasicInfo: '实例基本信息',
    instanceResponseData: '实例运行结果',
    backToInstanceList: '返回实例列表',
    runAlgorithmSuccess: '运行算法实例成功',
    runAlgorithmError: '运行算法实例失败',
    dataSource: '数据源',
    ...
    paramName: '参数名',
    paramValue: '参数值',
    queryParametersForData: '数据获取参数',
    queryInstanceResultError: '获取实例运行结果失败',
    deleteInstanceSuccess: '删除实例成功',
    deleteInstanceError: '删除实例失败',
    deleteInstance: '删除实例',
